...
public class IslandMaker {
		...
		for(int r=0; r<R; r++){
			...
			for(int c=0; c<C; c++){	
				...
				if(abs(abs(c-cr)-cr)+abs(abs(r-rr)-rr)+ran>40){
					height[r][c]=(abs(abs(c-cr)-cr)+abs(abs(r-rr)-rr))*5+rand.nextInt(((20-1)+1)+1);
					type[r][c]= PLAIN;
				}
			}
		}
		...
		for(int river=1; river<=limit; river++){
			...
			if(found){//make the river
				...
				while(progress){
					...
					}if(height[start-1][startc]<lowest){
						lowest=height[start-1][startc];
						nextr=start-1; nextc=startc;
					}if(height[start-1][startc+1]<lowest){
						lowest=height[start-1][startc+1];
						nextr=start-1; nextc=startc+1;
					}if(height[start][startc-1]<lowest){
	...
	public static ImageIcon pic(String place){
		...
		if(place.equals("ocean")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/Ocean.png"));
		}else if (place.equals("plain")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/Plain.png"));
		}else if (place.equals("mountain")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/Mountain.png"));
		}else if (place.equals("volcano")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/Volcano.png"));
		}else if (place.equals("river")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/River.png"));
		}else if (place.equals("lake")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/Lake.png"));
		}else if (place.equals("forest")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/Forest.png"));
		}else if (place.equals("beach")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/Beach.png"));
		}
		else if(place.equals("wocean")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/WOcean.png"));
		}else if (place.equals("wplain")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/WPlain.png"));
		}else if (place.equals("wmountain")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/WMountain.png"));
		}else if (place.equals("wvolcano")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/WVolcano.png"));
		}else if (place.equals("wriver")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/WRiver.png"));
		}else if (place.equals("wlake")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/WLake.png"));
		}else if (place.equals("wforest")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/WForest.png"));
		}else if (place.equals("wbeach")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/WBeach.png"));
		}
		else if(place.equals("focean")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/FOcean.png"));
		}else if (place.equals("fplain")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/FPlain.png"));
		}else if (place.equals("fmountain")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/FMountain.png"));
		}else if (place.equals("fvolcano")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/FVolcano.png"));
		}else if (place.equals("friver")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/FRiver.png"));
		}else if (place.equals("flake")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/FLake.png"));
		}else if (place.equals("fforest")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/FForest.png"));
		}else if (place.equals("fbeach")){
			icon = new ImageIcon(IslandMaker.class.getResource("/pics/FBeach.png"));
		}
		return icon;
	}
